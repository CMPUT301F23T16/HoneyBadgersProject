...
public class EditItemFragmentTest {
    ...
    public void EditItemTest() throws InterruptedException {
        ...
        ViewInteraction appCompatButton20 = onView(allOf(withText("test_add"),isDisplayed()));
        appCompatButton20.perform(click());

        ViewInteraction appCompatEditText21 = onView(
                allOf(withId(R.id.add_item_name), isDisplayed()));
        appCompatEditText21.perform(replaceText("test_edit"), closeSoftKeyboard());

        ViewInteraction appCompatEditText22 = onView(
                allOf(withId(R.id.add_item_date), isDisplayed()));
        appCompatEditText22.perform(replaceText("2023-04-29"), closeSoftKeyboard());

        ViewInteraction appCompatEditText23 = onView(allOf(withId(R.id.add_item_price),isDisplayed()));
        appCompatEditText23.perform(replaceText("29"), closeSoftKeyboard());
        ...
        Thread.sleep(rand);
        onView(withText("test_edit")).check(matches(isDisplayed()));
        onView(withText("2023-04-29")).check(matches(isDisplayed()));
        onView(withText("$29.00")).check(matches(isDisplayed()));
    }
    ...
    public void cleanup() throws InterruptedException {
        ...
        try {
            onView(withText("test_edit")).check(matches(isDisplayed()));
            onView(AllOf.allOf(withId(R.id.check_box), hasSibling(withText("test_edit")))).perform(click());
